...
***
If you encounter any bugs or have any feature requests, please submit an issue on the [GitHub repository](https://github.com/TODOvue/todovue-card/issues). When submitting an issue, please include the following information:
...
***
If you want to contribute code changes to `TODOvue Card`, please follow these guidelines:
